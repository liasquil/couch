...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CouchRequest.accepted'
        db.delete_column(u'couches_couchrequest', 'accepted')

        # Adding field 'CouchRequest.decision'
        db.add_column(u'couches_couchrequest', 'decision',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CouchRequest.decision_seen'
        db.add_column(u'couches_couchrequest', 'decision_seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CouchRequest.accepted'
        db.add_column(u'couches_couchrequest', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'CouchRequest.decision'
        db.delete_column(u'couches_couchrequest', 'decision')

        # Deleting field 'CouchRequest.decision_seen'
        db.delete_column(u'couches_couchrequest', 'decision_seen')
