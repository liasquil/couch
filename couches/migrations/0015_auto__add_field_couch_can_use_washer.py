...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Couch.can_use_washer'
        db.add_column(u'couches_couch', 'can_use_washer',
                      self.gf('django.db.models.fields.CharField')(default='YES', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Couch.can_use_washer'
        db.delete_column(u'couches_couch', 'can_use_washer')
