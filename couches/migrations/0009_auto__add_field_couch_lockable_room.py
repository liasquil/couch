...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Couch.lockable_room'
        db.add_column(u'couches_couch', 'lockable_room',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Couch.lockable_room'
        db.delete_column(u'couches_couch', 'lockable_room')
