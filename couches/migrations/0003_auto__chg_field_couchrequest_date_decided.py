...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CouchRequest.date_decided'
        db.alter_column(u'couches_couchrequest', 'date_decided', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CouchRequest.date_decided'
        raise RuntimeError("Cannot reverse this migration. 'CouchRequest.date_decided' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'CouchRequest.date_decided'
        db.alter_column(u'couches_couchrequest', 'date_decided', self.gf('django.db.models.fields.DateTimeField')())
