...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Couch.uncomfortable_capacity'
        db.add_column(u'couches_couch', 'uncomfortable_capacity',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Couch.uncomfortable_capacity'
        db.delete_column(u'couches_couch', 'uncomfortable_capacity')
