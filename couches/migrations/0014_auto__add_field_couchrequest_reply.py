...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CouchRequest.reply'
        db.add_column(u'couches_couchrequest', 'reply',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CouchRequest.reply'
        db.delete_column(u'couches_couchrequest', 'reply')
