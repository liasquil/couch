...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Couch.longitude'
        db.alter_column(u'couches_couch', 'longitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=7))

        # Changing field 'Couch.latitude'
        db.alter_column(u'couches_couch', 'latitude', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=7))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Couch.longitude'
        raise RuntimeError("Cannot reverse this migration. 'Couch.longitude' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Couch.longitude'
        db.alter_column(u'couches_couch', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=7))

        # User chose to not deal with backwards NULL issues for 'Couch.latitude'
        raise RuntimeError("Cannot reverse this migration. 'Couch.latitude' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Couch.latitude'
        db.alter_column(u'couches_couch', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=7))
    ...
    models = {
        ...
        u'couches.couch': {
            ...
            'can_use_washer': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'latitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '7'}),
            'lockable_room': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'longitude': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '9', 'decimal_places': '7'}),
            ...
            'uncomfortable_capacity': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
        ...
        u'couches.couchrequest': {
            ...
            'decision': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
            'decision_seen': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
