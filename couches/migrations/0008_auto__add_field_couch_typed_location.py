...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Couch.typed_location'
        db.add_column(u'couches_couch', 'typed_location',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Couch.typed_location'
        db.delete_column(u'couches_couch', 'typed_location')
