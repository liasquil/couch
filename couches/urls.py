...
urlpatterns = patterns('',
    ...
    url(r'^(?P<couch_id>\d+)/activate/$', 'couches.views.set_status', {'action':'activate'}, name='activate'),
    url(r'^(?P<couch_id>\d+)/deactivate/$', 'couches.views.set_status', {'action':'deactivate'}, name='deactivate'),
