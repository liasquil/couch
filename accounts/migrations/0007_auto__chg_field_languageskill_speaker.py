...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LanguageSkill.speaker'
        db.alter_column(u'accounts_languageskill', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Profile']))

    def backwards(self, orm):

        # Changing field 'LanguageSkill.speaker'
        db.alter_column(u'accounts_languageskill', 'speaker_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser']))
    ...
    models = {
        ...
        u'accounts.languageskill': {
            ...
            'speaker': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.Profile']"})
        },
