...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LanguageSkill.language'
        db.delete_column(u'accounts_languageskill', 'language_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LanguageSkill.speaker_profile'
        raise RuntimeError("Cannot reverse this migration. 'LanguageSkill.speaker_profile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LanguageSkill.speaker_profile'
        ...
        # User chose to not deal with backwards NULL issues for 'LanguageSkill.language'
        raise RuntimeError("Cannot reverse this migration. 'LanguageSkill.language' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LanguageSkill.language'
        db.add_column(u'accounts_languageskill', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Language']),
                      keep_default=False)
    ...
    models = {
        ...
        u'accounts.languageskill': {
            'Meta': {'object_name': 'LanguageSkill'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
