...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.given_name'
        db.add_column(u'accounts_profile', 'given_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Profile.family_name'
        db.add_column(u'accounts_profile', 'family_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.given_name'
        db.delete_column(u'accounts_profile', 'given_name')

        # Deleting field 'Profile.family_name'
        db.delete_column(u'accounts_profile', 'family_name')
