...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_languageskill', (
            ...
            ('speaker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.CustomUser'])),
        ...
        # Changing field 'CustomUser.profile'
        db.alter_column(u'accounts_customuser', 'profile_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['accounts.Profile']))
        # Adding unique constraint on 'CustomUser', fields ['profile']
        db.create_unique(u'accounts_customuser', ['profile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CustomUser', fields ['profile']
        db.delete_unique(u'accounts_customuser', ['profile_id'])
        ...
        # Changing field 'CustomUser.profile'
        db.alter_column(u'accounts_customuser', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Profile'], null=True))
