...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.year_of_birth_public'
        db.add_column(u'accounts_profile', 'year_of_birth_public',
        ...
        # Adding field 'Profile.self_description'
        db.add_column(u'accounts_profile', 'self_description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=1500, blank=True),
                      keep_default=False)


        # Changing field 'Profile.date_of_birth'
        db.alter_column(u'accounts_profile', 'date_of_birth', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Profile.year_of_birth_public'
        db.delete_column(u'accounts_profile', 'year_of_birth_public')

        # Deleting field 'Profile.day_and_month_of_birt_public'
        db.delete_column(u'accounts_profile', 'day_and_month_of_birt_public')

        # Deleting field 'Profile.self_description'
        db.delete_column(u'accounts_profile', 'self_description')


        # Changing field 'Profile.date_of_birth'
        db.alter_column(u'accounts_profile', 'date_of_birth', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 3, 21, 0, 0)))
